...
import { IInitiateSignupUseCase } from "../../../application/IUseCases/auth/IInitiateSignupUseCase";
import { ICompleteSignupUseCase } from "../../../application/IUseCases/auth/ICompleteSignupUseCase";
...
export class GymAuthenticationController {
    ...
    async login(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const data = await this._gymLoginUseCase.execute({ email, password, device, browser, os, ip });
